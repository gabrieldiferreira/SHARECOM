        ...
        isIOS ? (
          ...
          >
            <div className="flex items-start gap-3">
              ...
              >
                <Image src="/logo.png" alt="SHARECOM App Logo" width={40} height={40} className="w-full h-full object-cover [mask-image:radial-gradient(circle,black_55%,transparent_75%)]" />
              </div>
